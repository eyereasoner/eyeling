...
- prefer small structures over opaque complexity
- expose the line from data to conclusion
- build the check into the artifact itself
- treat clarity as part of rigor
- treat inspectability as part of honesty

The world unfolds.  
From somewhere inside that unfolding, it is also read.

**Follows From** names that whole motion in the simplest possible way: show what follows, and what it follows from.
