...
```text
examples/
  <name>.js             self-contained executable example
...
The repository currently contains **53 N3-compiled SEE examples**. Each example has a Notation3 source, an executable `examples/<name>.js`, TriG input evidence, a reference output, and a documentation page. `node see/see.js generate ... --force` regenerates individual examples from files under `see/examples/n3/`.
...
| <a id="example-context-association"></a>[Context association](#example-context-association) | compiled from Notation3 by `see.js`; external RDF/TriG named graphs associate Bob's data graph with Data Integrity proof and metadata proof contexts. | [doc](examples/doc/context_association.md), [js](examples/context_association.js), [input](examples/input/context_association.trig), [output](examples/output/context_association.md), [n3](examples/n3/context_association.n3) |
