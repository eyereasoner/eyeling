...
const NAME = "builtin_coverage";
const TITLE = "Builtin coverage smoke";
...
const RULES = [
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": "string:containsIgnoringCase"
        },
        "o": {
          "kind": "lit",
          "value": "he"
    ...
    "headComment": [
      ...
      ":assurance :difference ?difference",
      ":assurance :quotient ?quotient",
      ":assurance :integerQuotient ?iq",
      ":assurance :remainder ?rem",
      ":assurance :negation ?neg",
      ":assurance :absoluteValue ?abs",
      ":assurance :degrees ?deg",
      ":assurance :stringLength ?len",
      ":assurance :concatenation ?cat",
      ":assurance :format ?fmt",
      ":assurance :scrape ?scrape",
      ":assurance :charAt ?char",
      ":assurance :setCharAt ?set",
      ":assurance :sha256 ?sha",
      ":assurance :first ?first",
      ":assurance :rest ?rest",
      ":assurance :last ?last",
      ":assurance :listLength ?listLen",
      ":assurance :reverse ?rev",
      ":assurance :removed ?removed",
      ":assurance :appended ?appended",
      ":assurance :member ?member",
      ":assurance :year ?year",
      ":assurance :month ?month",
      ":assurance :formula ?formula"
    ]
  }
];
const QUERIES = [
