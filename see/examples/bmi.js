...
const NAME = "bmi";
const TITLE = "BMI — Body Mass Index example.";
const EXPECTED_INPUT_FACTS = 3;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Inputs were already metric, so kilograms stay kilograms and centimeters are divided by 100 to obtain meters."
        }
      }
    ],
    "bodyComment": [
  ...
  },
  {
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "US inputs were converted to SI units: pounds to kilograms and inches to meters."
        }
      }
    ],
    "bodyComment": [
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      "(?Bmi 100) math:product ?BmiX100",
      "?BmiX100 math:rounded ?BmiRoundedInt",
      "(?BmiRoundedInt 100) math:quotient ?BmiRounded",
      "(18.5 ?M2) math:product ?HealthyMin",
      "(24.9 ?M2) math:product ?HealthyMax",
      "(?HealthyMin 10) math:product ?MinX10",
      "(?HealthyMax 10) math:product ?MaxX10",
      "?MinX10 math:rounded ?MinRoundedInt",
      "?MaxX10 math:rounded ?MaxRoundedInt",
      "(?MinRoundedInt 10) math:quotient ?HealthyMinRounded",
      "(?MaxRoundedInt 10) math:quotient ?HealthyMaxRounded"
    ],
    "headComment": [
      ":Case :heightSquared ?M2",
      ":Case :bmi ?Bmi",
      ":Case :bmiRounded ?BmiRounded",
      ":Case :healthyMinKg ?HealthyMin",
      ":Case :healthyMaxKg ?HealthyMax",
      ":Case :healthyMinKgRounded ?HealthyMinRounded",
      ":Case :healthyMaxKgRounded ?HealthyMaxRounded"
    ]
  },
  {
    "kind": "rule",
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      "(?M 100) math:product ?Cm",
      "?Cm math:rounded ?CmRounded"
    ],
    "headComment": [
      ":Answer :bmi ?BmiRounded",
      ":Answer :category ?Category",
      ":Answer :healthyMinKg ?HealthyMinRounded",
      ":Answer :healthyMaxKg ?HealthyMaxRounded",
      ":Answer :heightCm ?CmRounded"
    ]
  },
  {
    "kind": "rule",
    ...
    "head": [
      {
        ...
        "o": {
          "kind": "lit",
          "value": "BMI is defined as weight in kilograms divided by height in meters squared."
        }
      },
      {
        "s": {
        ...
        "o": {
          "kind": "lit",
          "value": "The normalized weight and height were used to compute BMI, then the result was mapped to the WHO adult category table."
        }
      },
      {
        "s": {
    ...
    "headComment": [
      ...
      ":Reason :categoryRule ?Category",
      ":Reason :unitsExplanation ?Units"
    ]
  },
  {
    "kind": "fuse",
      ...
      },
      {
        "s": {
          ...
          "items": [
            ...
            {
              "kind": "lit",
              "value": " cm, a healthy-weight range is about "
            },
            {
              "kind": "var",
              "value": "HealthyMinRounded"
            ...
            {
              "kind": "lit",
              "value": "This program first normalizes the input to SI units, computes BMI, and then applies WHO adult categories as half-open intervals. "
            },
            {
              "kind": "lit",
              "value": "The healthy-weight band is the weight range at the same height that corresponds to BMI 18.5 through 24.9.\n\n"
            }
          ]
        },
        "p": {
