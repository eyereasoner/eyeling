...
const TITLE = "Fibonacci Example (Big)";
const EXPECTED_INPUT_FACTS = 27;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "bodyComment": [
      ...
      ":Run :sampleIndex 10",
      ":Run :sampleIndex 100",
      ":Run :sampleIndex 1000",
      ":Run :sampleIndex 10000",
      ":Run :method :bigIntegerRecurrence",
      ":Sample10000 :value ?Value",
      ":Sample10000 :digits 2090",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":fibonacciExample :certifies ?Sample"
    ],
    "conclusionComment": [
      ":fibonacciExample :certifies ?Sample"
    ]
