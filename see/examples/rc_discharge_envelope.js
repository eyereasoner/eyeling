...
const TITLE = "RC Discharge Envelope";
const EXPECTED_INPUT_FACTS = 12;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "bodyComment": [
      ":case :initialVoltage ?Initial",
      ":case :decayUpper ?DecayUpper",
      ":case :candidateStep ?Step",
      "?Step :index ?Index",
  ...
  },
  {
    ...
    "bodyComment": [
      ":case :exactDecaySymbol ?Symbol",
      ":case :decayLower ?Lower",
      ":case :decayUpper ?Upper",
      ":case :firstBelowToleranceStep ?Step",
      "?Step :index ?Index",
      "?Step :timeSeconds ?Time",
      "?Step :upperVoltage ?Voltage",
