...
const TITLE = "EV Roadtrip Planner";
const EXPECTED_INPUT_FACTS = 64;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "bodyComment": [
      "?Plan rdf:type gps:Plan",
      "?Plan gps:duration ?Dur",
      "?Plan gps:cost ?Cost",
      "?Plan gps:belief ?Bel",
      ":Thresholds :minBelief ?MinBel",
      ":Thresholds :maxCost ?MaxCost",
      ":Thresholds :maxDuration ?MaxDur",
  ...
  },
  {
    ...
    "bodyComment": [
      "1 log:notIncludes { :PlanSet :selected :plan1 }"
    ],
    "headComment": []
  },
  {
    ...
    "bodyComment": [
      ":PlanSet :selected ?Plan",
      ":PlanSet :acceptableCount ?Acceptable",
      ":PlanSet :fuelBudget ?FuelBudget",
      "?Plan gps:actions ?Actions",
      "?Plan gps:duration ?Duration",
      "?Plan gps:cost ?Cost",
      "?Plan gps:belief ?Belief",
      "?Plan gps:comfort ?Comfort",
      "?Plan gps:finalCity ?City",
      "?Plan gps:finalBattery ?Battery",
      "?Plan gps:finalPass ?Pass",
      "?Plan gps:fuelRemaining ?FuelRemaining",
      ":plan2 gps:actions ?Actions2",
      ":plan2 gps:duration ?Duration2",
      ":plan2 gps:cost ?Cost2",
      ":plan2 gps:belief ?Belief2",
      ":plan2 gps:comfort ?Comfort2",
      ":plan2 gps:finalCity ?City2",
      ":plan2 gps:finalBattery ?Battery2",
      ":plan2 gps:finalPass ?Pass2",
      ":plan3 gps:actions ?Actions3",
      ":plan3 gps:duration ?Duration3",
      ":plan3 gps:cost ?Cost3",
      ":plan3 gps:belief ?Belief3",
      ":plan3 gps:comfort ?Comfort3",
      ":plan3 gps:finalCity ?City3",
      ":plan3 gps:finalBattery ?Battery3",
      ":plan3 gps:finalPass ?Pass3",
      ":plan4 gps:actions ?Actions4",
      ":plan4 gps:duration ?Duration4",
      ":plan4 gps:cost ?Cost4",
      ":plan4 gps:belief ?Belief4",
      ":plan4 gps:comfort ?Comfort4",
      ":plan4 gps:finalCity ?City4",
      ":plan4 gps:finalBattery ?Battery4",
      ":plan4 gps:finalPass ?Pass4",
      ":plan5 gps:actions ?Actions5",
      ":plan5 gps:duration ?Duration5",
      ":plan5 gps:cost ?Cost5",
      ":plan5 gps:belief ?Belief5",
      ":plan5 gps:comfort ?Comfort5",
      ":plan5 gps:finalCity ?City5",
      ":plan5 gps:finalBattery ?Battery5",
      ":plan5 gps:finalPass ?Pass5",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":evRoadtripPlanner :selects ?Plan"
    ],
    "conclusionComment": [
      ":evRoadtripPlanner :selects ?Plan"
    ]
