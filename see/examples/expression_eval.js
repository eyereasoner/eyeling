...
const NAME = "expression_eval";
const TITLE = "A tiny expression evaluator in N3";
const EXPECTED_INPUT_FACTS = 17;
const RULES = [
  {
    "kind": "backward",
    "id": 1,
