...
const TITLE = "Gray Code Counter";
const EXPECTED_INPUT_FACTS = 7;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
  ...
  },
  {
    ...
    "bodyComment": [
      ":Counter :steps ?Steps",
      ":Counter :statesVisited ?Steps",
      ":Counter :uniqueStateCount ?Steps",
      ":Counter :maxHammingDistance 1"
    ],
    "headComment": [
  ...
  },
  {
    ...
    "bodyComment": [
      ":Counter :bits ?Bits",
      ":Counter :statesVisited ?Visited",
      ":Counter :uniqueStateCount ?Unique",
      ":Counter :sequencePrefix ?Prefix",
      ":Counter :wrapTransition ?Wrap",
      ":Counter :maxHammingDistance ?Max",
      ":Counter :validGrayCycle true",
