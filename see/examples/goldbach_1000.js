...
const TITLE = "Goldbach 1000";
const EXPECTED_INPUT_FACTS = 28;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "head": [
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":boundedGoldbachCondition"
        },
        "o": {
          "kind": "lit",
          "value": true
  ...
  },
  {
    ...
    "bodyComment": [
      "1 log:notIncludes { :BoundedRun :boundedGoldbachCondition true }"
    ],
    "headComment": []
  },
  {
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":BoundedGoldbachEvidence"
        }
      }
    ],
    "bodyComment": [
      ":BoundedRun :minEven ?Min",
      ":BoundedRun :maxEven ?Max",
      ":BoundedRun :evenCount ?Count",
      ":BoundedRun :sampleWitnesses ?Samples",
      ":BoundedRun :boundedGoldbachCondition true",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":goldbach1000 :demonstrates ?Feature"
    ],
    "conclusionComment": [
      ":goldbach1000 :demonstrates ?Feature"
    ]
