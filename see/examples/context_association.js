...
const NAME = "context_association";
const TITLE = "Context association";
const EXPECTED_INPUT_FACTS = 0;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
        ...
        "o": {
          ...
          "atoms": [
            ...
            },
            {
              ...
              "p": {
                "kind": "iri",
                "value": "sec:cryptosuite"
              },
              "o": {
                "kind": "lit",
                "value": "ecdsa-rdfc-2019"
              }
            },
            {
              "s": {
              ...
              "o": {
                "kind": "iri",
                "value": "<https://university.example/issuers/14>"
              }
            },
            {
              "s": {
              ...
              "p": {
                "kind": "iri",
                "value": "sec:validUntil"
              },
              "o": {
                "kind": "lit",
                "value": "2025-04-03T00:00:00.000Z"
              }
            }
          ]
        }
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":contextAssociationVerified"
        }
      }
    ],
    "bodyComment": [
      ...
      "?signatureContext log:includes { ?dataGraph sec:proof ?dataSignature . ?proof rdf:type sec:DataIntegrityProof . ?proof sec:cryptosuite \"ecdsa-rdfc-2019\" . ?proof sec:issuer <https://university.example/issuers/14> . ?proof sec:validUntil \"2025-04-03T00:00:00.000Z\" }",
      "?metadataGraph log:nameOf ?metadataContext",
      "?metadataContext log:includes { ?signatureGraph sec:proof ?metadataSignature . ?metadataProof rdf:type sec:DataIntegrityProof . ?metadataProof sec:proofPurpose \"assertionMethod\" }"
    ],
    "headComment": [
