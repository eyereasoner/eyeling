...
const TITLE = "School Placement Route Audit";
const EXPECTED_INPUT_FACTS = 26;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "head": [
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":walkingLimitExceeded"
        }
      }
    ],
    "bodyComment": [
      "?Student :provisional ?Provisional",
      "?Student :auditedBest ?Audited",
      "?Student :walkingMeters ?Walk",
    ...
    "head": [
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":assignmentDiffersFromAuditedBest"
        }
      }
    ],
    "bodyComment": [
  ...
  },
  {
    ...
    "head": [
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":affectedChildren"
        },
        "o": {
          "kind": "lit",
          "value": "Ada, Björn, Davi"
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":recommendedAssignments"
        },
        "o": {
          "kind": "lit",
          "value": "Ada -> Lindholmen; Björn -> Backa; Clara -> Haga; Davi -> Haga"
        }
      }
    ],
    "bodyComment": [
    ...
    "headComment": [
      ":Audit :result \"fail\"",
      ":Audit :affectedChildren \"Ada, Björn, Davi\"",
      ":Audit :largestHiddenDetour \"Ada, 3000 m\"",
      ":Audit :recommendedAssignments \"Ada -> Lindholmen; Björn -> Backa; Clara -> Haga; Davi -> Haga\""
    ]
  },
  {
    "kind": "rule",
    ...
    "bodyComment": [
      ":Audit :result ?Result",
      ":Audit :affectedChildren ?Affected",
      ":Audit :largestHiddenDetour ?Detour",
      ":Audit :recommendedAssignments ?Assignments",
