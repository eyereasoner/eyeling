...
const TITLE = "Dijkstra Risk Path";
const EXPECTED_INPUT_FACTS = 21;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "head": [
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":riskCanOutweighRawCost"
        }
      }
    ],
    "bodyComment": [
      ":pathViaC :rawCost ?ViaRaw",
      ":pathViaC :score ?ViaCScore",
      ":pathViaC :riskSum ?Risk",
      ":pathB :rawCost ?BestRaw",
      ":pathB :score ?Best",
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      ":Case :trustGate :noEnumeratedPathIsLower",
      ":Case :notes :riskCanOutweighRawCost",
      ":pathB :routeText ?Route",
      ":pathB :rawCost ?Raw",
      ":pathB :riskSum ?Risk",
      ":pathB :score ?Score",
      ":pathB :edgeCount ?Edges",
