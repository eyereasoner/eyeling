...
const NAME = "group_inverse_uniqueness";
const TITLE = "In a group, the inverse of an element is unique.";
const EXPECTED_INPUT_FACTS = 6;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
