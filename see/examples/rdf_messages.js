...
const NAME = "rdf_messages";
const TITLE = "RDF Messages";
const EXPECTED_INPUT_FACTS = 25;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "bodyComment": [
      "?Log rdf:type msg:MessageLog",
      "?Log msg:message ?Message",
      "?Message rdf:type msg:RDFMessage",
  ...
  },
  {
    ...
    "bodyComment": [
      "?Message rdf:type msg:RDFMessage",
      "?Message msg:expectedResult ?Result",
  ...
  },
  {
    ...
    "bodyComment": [
      "?Message rdf:type msg:RDFMessage",
      "?Message msg:payloadKind :heartbeat"
    ],
    "headComment": [
  ...
  },
  {
    ...
    "bodyComment": [
      "?First rdf:type msg:RDFMessage",
      "?First msg:localBlankLabel ?Label",
      "?Second rdf:type msg:RDFMessage",
      "?Second msg:localBlankLabel ?Label",
  ...
  },
  {
    ...
    "head": [
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":differentObservationsStayContextual"
        },
        "o": {
          "kind": "lit",
          "value": true
    ...
    "bodyComment": [
      "?First rdf:type msg:RDFMessage",
      "?First msg:payloadResult ?FirstResult",
      "?Second rdf:type msg:RDFMessage",
      "?Second msg:payloadResult ?SecondResult",
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      ":m001 msg:payloadResult ?FirstResult",
      ":m002 msg:boundaryExplicit true",
      ":m002 msg:emptyMessageAllowed true",
      ":m003 msg:boundaryExplicit true",
      ":m003 msg:payloadResult ?SecondResult",
      ":BlankNodeScope :reusedLabel ?Label",
      ":BlankNodeScope :isPerMessage true",
      ":MessageContext :differentObservationsStayContextual true",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":rdfMessagesExample :demonstrates ?Feature"
    ],
    "conclusionComment": [
      ":rdfMessagesExample :demonstrates ?Feature"
    ]
