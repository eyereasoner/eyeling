...
const NAME = "euler_identity";
const TITLE = "Euler identity (exact, certificate-friendly):";
const EXPECTED_INPUT_FACTS = 10;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
