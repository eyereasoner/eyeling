...
const RULES = [
  ...
  },
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": "string:notMatches"
        },
        "o": {
          "kind": "lit",
          "value": "diabetes|medical"
        }
      }
    ],
    "head": [
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":minimizationStripsSensitiveTerms"
        },
        "o": {
          "kind": "lit",
          "value": true
    ...
    "bodyComment": [
      ":insight :serializedLowercase ?s",
      "?s string:notMatches \"diabetes|medical\""
    ],
    "headComment": [
      ":assurance :minimizationStripsSensitiveTerms true"
    ]
  },
  {
    "kind": "rule",
    ...
    "bodyComment": [
      ":insight :scopeDevice ?device",
      ":insight :scopeEvent ?event",
      ":insight :expiresAt ?expiry"
    ],
    "headComment": [
      ":assurance :scopeComplete true"
    ]
  },
  {
    "kind": "rule",
    ...
    "bodyComment": [
      "?_bodyBlank7 odrl:action odrl:use",
      "?_bodyBlank7 odrl:target :insight",
      "?_bodyBlank8 odrl:rightOperand \"shopping_assist\"",
      "?_bodyBlank7 odrl:constraint ?_bodyBlank8",
      ":policy odrl:permission ?_bodyBlank7",
    ...
    "headComment": [
      ...
      ":assurance :authorizationAllowed true"
    ]
  },
  {
    "kind": "rule",
    ...
    "head": [
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Track sugar per serving while you scan"
        }
      },
      {
        "s": {
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      "?candidate rdf:type :Product",
      "?candidate :sugarTenths ?candidateSugar",
      "?scannedSugar math:greaterThan ?candidateSugar",
      "1 log:notIncludes { ?other rdf:type :Product . ?other :sugarTenths ?otherSugar . ?scannedSugar math:greaterThan ?otherSugar . ?otherSugar math:lessThan ?candidateSugar }"
    ],
    "headComment": [
  ...
  },
  {
    ...
    "headComment": [
      ":assurance :dutyTimingConsistent true"
    ]
  },
  {
    "kind": "rule",
    ...
    "bodyComment": [
      "?_bodyBlank9 odrl:action odrl:distribute",
      "?_bodyBlank10 odrl:rightOperand \"marketing\"",
      "?_bodyBlank9 odrl:constraint ?_bodyBlank10",
      ":policy odrl:prohibition ?_bodyBlank9"
    ],
    "headComment": [
      ":assurance :marketingProhibited true"
    ]
  },
  {
    "kind": "rule",
    ...
    "headComment": [
      ":assurance :filesWrittenExpected true"
    ]
  },
  {
    "kind": "rule",
    ...
    "headComment": [
      ":assurance :bannerFlagsHighSugar true"
    ]
  },
  {
    "kind": "rule",
  ...
  },
  {
    ...
    "bodyComment": [
      "?_bodyBlank11 odrl:action ?action",
      ":policy odrl:prohibition ?_bodyBlank11",
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      ":case :auditEntries ?auditEntries",
      ":case :filesWritten ?filesWritten",
      "?alt :productName ?altName",
      ":insight :metric ?metric",
      ":insight :thresholdDisplay ?threshold",
      ":insight :scopeDevice ?device",
      ":insight :scopeEvent ?event",
      ":insight :retailer ?retailer",
      ":insight :expiresAt ?expiresAt",
      ":signature :alg ?alg",
