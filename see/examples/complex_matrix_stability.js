...
const TITLE = "Complex Matrix Stability";
const EXPECTED_INPUT_FACTS = 40;
const RULES = [
  {
    "kind": "backward",
    "id": 1,
  ...
  },
  {
    ...
    "bodyComment": [
      ":Case :unstableMatrix ?Mu",
      ":Case :stableMatrix ?Ms",
      ":Case :dampedMatrix ?Md",
      "?Mu :classification :unstable",
      "?Mu :spectralRadius 2",
      "?Ms :classification :stable",
      "?Ms :spectralRadius 1",
      "?Md :classification :damped",
      "?Md :spectralRadius 0"
    ],
    "headComment": [
  ...
  },
  {
    ...
    "bodyComment": [
      ":Case :scenarioOk true",
      ":A_unstable :pretty ?UnstableMatrix",
      ":A_unstable :spectralRadius ?Ru",
      ":A_stable :pretty ?StableMatrix",
      ":A_stable :spectralRadius ?Rs",
      ":A_damped :pretty ?DampedMatrix",
      ":A_damped :spectralRadius ?Rd",
