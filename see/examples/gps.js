...
const NAME = "gps";
const TITLE = "GPS route planning";
...
const RULES = [
  ...
  },
  {
          ...
          "items": [
            {
              ...
              "items": [
                {
                  "kind": "iri",
                  "value": ":drive_gent_brugge"
                },
                {
                  "kind": "iri",
                  "value": ":drive_brugge_oostende"
                }
              ]
            },
            {
    ...
    "headComment": [
      ...
      ":routeDirect :cost ?Cost",
      ":routeDirect :belief ?Bel",
      ":routeDirect :comfort ?Comf"
    ]
  },
  {
    "kind": "rule",
          ...
          "items": [
            {
              ...
              "items": [
                {
                  "kind": "iri",
                  "value": ":drive_gent_kortrijk"
                },
                {
                  "kind": "iri",
                  "value": ":drive_kortrijk_brugge"
                },
                {
                  "kind": "iri",
                  "value": ":drive_brugge_oostende"
    ...
    "headComment": [
      ...
      ":routeViaKortrijk :cost ?Cost",
      ":routeViaKortrijk :belief ?Bel",
      ":routeViaKortrijk :comfort ?Comf"
    ]
  },
  {
    "kind": "rule",
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Take the direct route via Brugge."
        }
      }
    ],
    "bodyComment": [
  ...
  },
  {
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "=== Answer ===\n%s\nRecommended route: %s\n\n=== Explanation ===\nFrom Gent to Oostende, the planner found two routes in this small map. The direct route (%s) takes %s seconds at cost %s, with belief %s and comfort %s. The alternative (%s) takes %s seconds at cost %s, with belief %s and comfort %s. So the direct route is faster, cheaper, more reliable, and slightly more comfortable."
            },
            {
              "kind": "var",
              "value": "Outcome"
    ...
    "bodyComment": [
      ...
      ":routeDirect :label ?BestLabel",
      ":routeDirect :duration ?BestDur",
      ":routeDirect :cost ?BestCost",
      ":routeDirect :belief ?BestBel",
      ":routeDirect :comfort ?BestComf",
      ":routeViaKortrijk :label ?AltLabel",
      ":routeViaKortrijk :duration ?AltDur",
      ":routeViaKortrijk :cost ?AltCost",
      ":routeViaKortrijk :belief ?AltBel",
      ":routeViaKortrijk :comfort ?AltComf",
