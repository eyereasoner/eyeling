...
const TITLE = "ODRL + DPV risk assessment with ranked, explainable output.";
const EXPECTED_INPUT_FACTS = 38;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    "body": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":Need_DataCannotBeRemoved"
        }
      },
      {
        "s": {
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "Risk: account/data removal is permitted without notice safeguards (no notice constraint and no duty to inform). Clause %s: %s"
            },
            {
              "kind": "var",
              "value": "cid"
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": "risk:LegalComplianceRisk"
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Account removal permitted without notice safeguards."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": "risk:UnwantedDataDeletion"
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": "risk:CustomerConfidenceLoss"
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": "dpv:RiskMitigationMeasure"
        }
      },
      {
        "s": {
        ...
        "o": {
          "kind": "lit",
          "value": "Add a notice constraint (minimum noticeDays) before account removal."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Add a duty to inform the consumer prior to account removal."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": "dpv:isMitigatedByMeasure"
        },
        "o": {
          "kind": "iri",
          "value": "_:m11"
    ...
    "bodyComment": [
      ...
      "?G log:includes { :PermDeleteAccount rdf:type odrl:Permission . :PermDeleteAccount odrl:action tosl:removeAccount . :PermDeleteAccount :clause ?clause }",
      "?G log:notIncludes { ?_bodyBlank3 odrl:leftOperand tosl:noticeDays . :PermDeleteAccount odrl:constraint ?_bodyBlank3 }",
      "?G log:notIncludes { ?_bodyBlank4 odrl:action odrl:inform . :PermDeleteAccount odrl:duty ?_bodyBlank4 }",
      "?clause :clauseId ?cid",
      "?clause :text ?txt",
      "(90 ?w) math:sum ?raw",
      "(\"Risk: account/data removal is permitted without notice safeguards (no notice constraint and no duty to inform). Clause %s: %s\" ?cid ?txt) string:format ?why"
    ],
    "headComment": [
      "_:src1 rdf:type risk:RiskSource",
      "_:src1 rdf:type risk:LegalComplianceRisk",
      "_:src1 dct:source :PermDeleteAccount",
      "_:src1 dct:description \"Account removal permitted without notice safeguards.\"",
      "_:risk1 rdf:type dpv:Risk",
      "_:risk1 rdf:type risk:UnwantedDataDeletion",
      "_:risk1 rdf:type risk:DataUnavailable",
      "_:risk1 rdf:type risk:DataErasureError",
      "_:risk1 rdf:type risk:DataLoss",
      "_:risk1 dct:source :PermDeleteAccount",
      "_:risk1 risk:hasRiskSource _:src1",
      "_:risk1 dpv:hasConsequence risk:DataLoss",
      "_:risk1 dpv:hasConsequence risk:DataUnavailable",
      "_:risk1 dpv:hasConsequence risk:CustomerConfidenceLoss",
      "_:risk1 dpv:hasImpact risk:FinancialLoss",
      "_:risk1 dpv:hasImpact risk:NonMaterialDamage",
      "_:risk1 :aboutClause ?clause",
      "_:risk1 :scoreRaw ?raw",
      "_:risk1 :violatesNeed :Need_DataCannotBeRemoved",
      "_:risk1 dct:description ?why",
      ":ProcessContext1 dpv:hasRisk _:risk1",
      "_:m11 rdf:type dpv:RiskMitigationMeasure",
      "_:m11 dct:description \"Add a notice constraint (minimum noticeDays) before account removal.\"",
      "_:m11 dpv:mitigatesRisk _:risk1",
      "_:m11 :suggestAdd { _headBlank5 rdf:type odrl:Constraint . _headBlank5 odrl:leftOperand tosl:noticeDays . _headBlank5 odrl:operator odrl:gteq . _headBlank5 odrl:rightOperand 14 . :PermDeleteAccount odrl:constraint _headBlank5 }",
      "_:m21 rdf:type dpv:RiskMitigationMeasure",
      "_:m21 dct:description \"Add a duty to inform the consumer prior to account removal.\"",
      "_:m21 dpv:mitigatesRisk _:risk1",
      "_:m21 :suggestAdd { _headBlank6 rdf:type odrl:Duty . _headBlank6 odrl:action odrl:inform . :PermDeleteAccount odrl:duty _headBlank6 }",
      "_:risk1 dpv:isMitigatedByMeasure _:m11",
      "_:risk1 dpv:isMitigatedByMeasure _:m21"
    ]
  },
  {
    "kind": "rule",
    ...
    "body": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":Need_ChangeOnlyWithPriorNotice"
        }
      },
      {
        "s": {
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "Risk: terms may change with notice (%s days) below consumer requirement (%s days). Clause %s: %s"
            },
            {
              "kind": "var",
              "value": "days"
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Notice for changing terms is shorter than consumer requirement."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Increase minimum noticeDays in the inform duty to meet the consumer requirement."
        }
      },
      {
        "s": {
    ...
    "bodyComment": [
      ...
      ":Need_ChangeOnlyWithPriorNotice :minNoticeDays ?req",
      "?G log:includes { :PermChangeTerms rdf:type odrl:Permission . :PermChangeTerms odrl:action tosl:changeTerms . :PermChangeTerms :clause ?clause . ?_bodyBlank7 odrl:action odrl:inform . ?_bodyBlank8 odrl:leftOperand tosl:noticeDays . ?_bodyBlank8 odrl:rightOperand ?days . ?_bodyBlank7 odrl:constraint ?_bodyBlank8 . :PermChangeTerms odrl:duty ?_bodyBlank7 }",
      "?days math:lessThan ?req",
      "?clause :clauseId ?cid",
      "?clause :text ?txt",
      "(70 ?w) math:sum ?raw",
      "(\"Risk: terms may change with notice (%s days) below consumer requirement (%s days). Clause %s: %s\" ?days ?req ?cid ?txt) string:format ?why"
    ],
    "headComment": [
      "_:src2 rdf:type risk:RiskSource",
      "_:src2 rdf:type risk:PolicyRisk",
      "_:src2 dct:source :PermChangeTerms",
      "_:src2 dct:description \"Notice for changing terms is shorter than consumer requirement.\"",
      "_:risk2 rdf:type dpv:Risk",
      "_:risk2 rdf:type risk:PolicyRisk",
      "_:risk2 rdf:type risk:CustomerConfidenceLoss",
      "_:risk2 dct:source :PermChangeTerms",
      "_:risk2 risk:hasRiskSource _:src2",
      "_:risk2 dpv:hasConsequence risk:CustomerConfidenceLoss",
      "_:risk2 dpv:hasImpact risk:NonMaterialDamage",
      "_:risk2 :aboutClause ?clause",
      "_:risk2 :scoreRaw ?raw",
      "_:risk2 :violatesNeed :Need_ChangeOnlyWithPriorNotice",
      "_:risk2 dct:description ?why",
      ":ProcessContext1 dpv:hasRisk _:risk2",
      "_:m12 rdf:type dpv:RiskMitigationMeasure",
      "_:m12 dct:description \"Increase minimum noticeDays in the inform duty to meet the consumer requirement.\"",
      "_:m12 dpv:mitigatesRisk _:risk2",
      "_:m12 :suggestAdd { _headBlank9 rdf:type odrl:Duty . _headBlank9 odrl:action odrl:inform . _headBlank10 rdf:type odrl:Constraint . _headBlank10 odrl:leftOperand tosl:noticeDays . _headBlank10 odrl:operator odrl:gteq . _headBlank10 odrl:rightOperand 14 . _headBlank9 odrl:constraint _headBlank10 . :PermChangeTerms odrl:duty _headBlank9 }",
  ...
  },
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":Need_NoSharingWithoutConsent"
        }
      },
      {
        "s": {
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "Risk: user data sharing is permitted without an explicit consent constraint. Clause %s: %s"
            },
            {
              "kind": "var",
              "value": "cid"
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Data sharing permitted without explicit consent constraint."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": "risk:UnwantedDisclosureData"
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Add an explicit consent constraint before data sharing."
        }
      },
      {
        "s": {
    ...
    "bodyComment": [
      ...
      "?G log:includes { :PermShareData rdf:type odrl:Permission . :PermShareData odrl:action tosl:shareData . :PermShareData :clause ?clause }",
      "?G log:notIncludes { ?_bodyBlank11 odrl:leftOperand tosl:consent . ?_bodyBlank11 odrl:operator odrl:eq . ?_bodyBlank11 odrl:rightOperand true . :PermShareData odrl:constraint ?_bodyBlank11 }",
      "?clause :clauseId ?cid",
      "?clause :text ?txt",
      "(85 ?w) math:sum ?raw",
      "(\"Risk: user data sharing is permitted without an explicit consent constraint. Clause %s: %s\" ?cid ?txt) string:format ?why"
    ],
    "headComment": [
      "_:src3 rdf:type risk:RiskSource",
      "_:src3 rdf:type risk:PolicyRisk",
      "_:src3 dct:source :PermShareData",
      "_:src3 dct:description \"Data sharing permitted without explicit consent constraint.\"",
      "_:risk3 rdf:type dpv:Risk",
      "_:risk3 rdf:type risk:UnwantedDisclosureData",
      "_:risk3 rdf:type risk:CustomerConfidenceLoss",
      "_:risk3 dct:source :PermShareData",
      "_:risk3 risk:hasRiskSource _:src3",
      "_:risk3 dpv:hasConsequence risk:CustomerConfidenceLoss",
      "_:risk3 dpv:hasImpact risk:NonMaterialDamage",
      "_:risk3 dpv:hasImpact risk:FinancialLoss",
      "_:risk3 :aboutClause ?clause",
      "_:risk3 :scoreRaw ?raw",
      "_:risk3 :violatesNeed :Need_NoSharingWithoutConsent",
      "_:risk3 dct:description ?why",
      ":ProcessContext1 dpv:hasRisk _:risk3",
      "_:m13 rdf:type dpv:RiskMitigationMeasure",
      "_:m13 dct:description \"Add an explicit consent constraint before data sharing.\"",
      "_:m13 dpv:mitigatesRisk _:risk3",
      "_:m13 :suggestAdd { _headBlank12 rdf:type odrl:Constraint . _headBlank12 odrl:leftOperand tosl:consent . _headBlank12 odrl:operator odrl:eq . _headBlank12 odrl:rightOperand true . :PermShareData odrl:constraint _headBlank12 }",
  ...
  },
  {
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "Risk: portability is restricted because exporting user data is prohibited. Clause %s: %s"
            },
            {
              "kind": "var",
              "value": "cid"
    ...
    "head": [
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Data export is prohibited, reducing portability."
        }
      },
      {
        "s": {
      ...
      },
      {
        ...
        "o": {
          "kind": "lit",
          "value": "Add a permission allowing data export (or remove the prohibition) to support portability."
        }
      },
      {
        "s": {
    ...
    "bodyComment": [
      ...
      "?G log:includes { :ProhibitExportData rdf:type odrl:Prohibition . :ProhibitExportData odrl:action tosl:exportData . :ProhibitExportData :clause ?clause }",
      "?clause :clauseId ?cid",
      "?clause :text ?txt",
      "(60 ?w) math:sum ?raw",
      "(\"Risk: portability is restricted because exporting user data is prohibited. Clause %s: %s\" ?cid ?txt) string:format ?why"
    ],
    "headComment": [
      "_:src4 rdf:type risk:RiskSource",
      "_:src4 rdf:type risk:PolicyRisk",
      "_:src4 dct:source :ProhibitExportData",
      "_:src4 dct:description \"Data export is prohibited, reducing portability.\"",
      "_:risk4 rdf:type dpv:Risk",
      "_:risk4 rdf:type risk:PolicyRisk",
      "_:risk4 rdf:type risk:CustomerConfidenceLoss",
      "_:risk4 dct:source :ProhibitExportData",
      "_:risk4 risk:hasRiskSource _:src4",
      "_:risk4 dpv:hasConsequence risk:CustomerConfidenceLoss",
      "_:risk4 dpv:hasImpact risk:NonMaterialDamage",
      "_:risk4 :aboutClause ?clause",
      "_:risk4 :scoreRaw ?raw",
      "_:risk4 :violatesNeed :Need_DataPortability",
      "_:risk4 dct:description ?why",
      ":ProcessContext1 dpv:hasRisk _:risk4",
      "_:m14 rdf:type dpv:RiskMitigationMeasure",
      "_:m14 dct:description \"Add a permission allowing data export (or remove the prohibition) to support portability.\"",
      "_:m14 dpv:mitigatesRisk _:risk4",
      "_:m14 :suggestAdd { _headBlank13 rdf:type odrl:Permission . _headBlank13 odrl:assigner :Provider . _headBlank13 odrl:assignee :ConsumerExample . _headBlank13 odrl:action tosl:exportData . _headBlank13 odrl:target :UserData . :Policy1 odrl:permission _headBlank13 }",
  ...
  },
  {
    ...
    "bodyComment": [
      "?r rdf:type dpv:Risk",
      "?r :score ?s",
      "?s math:greaterThan 79"
    ],
    "headComment": [
      "?r dpv:hasSeverity risk:HighSeverity",
      "?r dpv:hasRiskLevel risk:HighRisk"
    ]
  },
  {
    "kind": "rule",
    ...
    "bodyComment": [
      ...
      "?r :score ?s",
      "?s math:lessThan 80",
      "?s math:greaterThan 49"
    ],
    "headComment": [
      "?r dpv:hasSeverity risk:ModerateSeverity",
      "?r dpv:hasRiskLevel risk:ModerateRisk"
    ]
  },
  {
    "kind": "rule",
    ...
    "headComment": [
      "?r dpv:hasSeverity risk:LowSeverity",
      "?r dpv:hasRiskLevel risk:LowRisk"
    ]
  }
];
const QUERIES = [
  ...
  },
  {
    ...
    "premiseComment": [
      "?r rdf:type dpv:Risk",
      "?r :score ?score",
      "?r dpv:hasRiskLevel ?lvl",
      "?r dpv:hasSeverity ?sev",
      "?r :aboutClause ?clause",
      "?r dct:description ?why",
      "?clause :clauseId ?cid",
      ...
      },
      {
        "s": {
          ...
          "items": [
            {
              "kind": "lit",
              "value": "  - mitigation for clause %s: %s\n"
            },
            {
              "kind": "var",
              "value": "cid"
