...
const NAME = "equivalence_classes_overlap_implies_same_class";
const TITLE = "If two equivalence classes share an element, they are the same class.";
const EXPECTED_INPUT_FACTS = 5;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "head": [
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":sharedMemberShowsSameClass"
        },
        "o": {
          "kind": "lit",
          "value": true
    ...
    "conclusion": [
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":sameClassBecauseOfSharedMember"
        },
        "o": {
          "kind": "list",
          "items": [
