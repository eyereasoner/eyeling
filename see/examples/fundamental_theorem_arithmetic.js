...
const TITLE = "Fundamental Theorem Arithmetic";
const EXPECTED_INPUT_FACTS = 16;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
  ...
  },
  {
    ...
    "bodyComment": [
      "1 log:notIncludes { :Case :reconstructsProduct true }"
    ],
    "headComment": []
  },
  {
    ...
    "bodyComment": [
      "1 log:notIncludes { :Case :uniqueUpToOrder true }"
    ],
    "headComment": []
  },
  {
    ...
    "bodyComment": [
      "1 log:notIncludes { :Case :allDistinctFactorsPrime true }"
    ],
    "headComment": []
  },
  {
    ...
    "body": [
      ...
      },
      {
        ...
        "p": {
          "kind": "iri",
          "value": ":totalFactorsWithMultiplicity"
        },
        "o": {
          "kind": "var",
          "value": "TotalFactors"
    ...
    "head": [
      {
        "s": {
          "kind": "iri",
          "value": ":fundamentalTheoremArithmetic"
        },
        "p": {
          "kind": "iri",
      ...
      },
      {
        ...
        "o": {
          "kind": "iri",
          "value": ":PrimeWitnesses"
        }
      }
    ],
    "bodyComment": [
      ":Case :n ?N",
      ":Case :flatFactorString ?Flat",
      ":Case :primePowerString ?PrimePower",
      ":Case :largestFlatFactorString ?LargestFlat",
      ":Case :sortedComparison ?Sorted",
      ":Case :smallestTrace ?Trace",
      ":SampleSummary :sampleCount ?SampleCount",
      ":SampleSummary :largestSample ?LargestSample",
      ":SampleSummary :totalFactorsWithMultiplicity ?TotalFactors",
      ":SampleSummary :distinctPrimesSeen ?Distinct",
      ":SampleSummary :sampleBlock ?SampleBlock",
      ":Case :reconstructsProduct true",
      ":Case :uniqueUpToOrder true",
      ":Case :allDistinctFactorsPrime true",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":fundamentalTheoremArithmetic :demonstrates ?Feature"
    ],
    "conclusionComment": [
      ":fundamentalTheoremArithmetic :demonstrates ?Feature"
    ]
