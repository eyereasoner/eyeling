...
const NAME = "rdf_message_flow";
const TITLE = "RDF Message Flow";
const EXPECTED_INPUT_FACTS = 42;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
  ...
  },
  {
    ...
    "bodyComment": [
      "?Message :atStage :interpret",
      "?Message msg:payloadKind :observation",
  ...
  },
  {
    ...
    "bodyComment": [
      "?Message :atStage :sink",
      "?Message msg:nextMessage ?Next",
      "?Next rdf:type msg:RDFMessage"
    ],
    "headComment": [
  ...
  },
  {
    ...
    "bodyComment": [
      ...
      ":m001 :route :archiveSink",
      ":m001 :releases :m002",
      ":m002 :atStage :sink",
      ":m002 msg:payloadResult ?SecondResult",
      ":m002 :route :archiveSink",
      ":m002 :releases :m003",
      ":m003 :atStage :sink",
      ":m003 msg:emptyMessageAllowed true",
      ":m003 :route :heartbeatSink",
      ":m003 :releases :m004",
      ":m004 :atStage :sink",
      ":m004 msg:payloadResult ?FourthResult",
      ":m004 :route :alertSink",
      ":m004 :releases :m005",
      ":m005 :atStage :sink",
      ":m005 msg:payloadResult ?FifthResult",
      ":m005 :route :alertSink",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":rdfMessageFlowExample :demonstrates ?Feature"
    ],
    "conclusionComment": [
      ":rdfMessageFlowExample :demonstrates ?Feature"
    ]
