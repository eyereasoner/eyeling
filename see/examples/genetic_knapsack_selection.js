...
const TITLE = "Genetic Knapsack Selection";
const EXPECTED_INPUT_FACTS = 14;
const RULES = [
  {
    "kind": "rule",
    "id": 1,
    ...
    "bodyComment": [
      ...
      ":FinalLocal :weight ?Weight",
      ":FinalLocal :value ?Value",
      ":NeighborSummary :bestNeighborValue ?BestNeighbor",
      ":NeighborSummary :capacityRespected true",
  ...
  },
  {
    ...
    "head": [
      {
        "s": {
          "kind": "iri",
          "value": ":geneticKnapsackSelection"
        },
        "p": {
          "kind": "iri",
    ...
    "bodyComment": [
      ":Run :capacity ?Capacity",
      ":Run :localSearchStopsAt :FinalLocal",
      ":FinalLocal :genome ?Genome",
      ":FinalLocal :selectedItems ?Items",
      ":FinalLocal :weight ?Weight",
      ":FinalLocal :value ?Value",
      ":FinalLocal :fitness ?Fitness",
      ":FinalLocal :generationsEvaluated ?Generations",
      ":ExhaustiveOptimum :genome ?OptGenome",
      ":ExhaustiveOptimum :value ?OptValue",
...
const QUERIES = [
  {
    ...
    "premiseComment": [
      ":geneticKnapsackSelection :selects ?Candidate"
    ],
    "conclusionComment": [
      ":geneticKnapsackSelection :selects ?Candidate"
    ]
