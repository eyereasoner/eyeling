...
let __traceDefaultPrefixes = null;
let __traceTermFormatter = null;

let __n3Lex = null;
let __N3ParserCtor = null;
...
// ===========================================================================
// Variable + blank-label collection helpers
// (used for explanation printing, blank-lifting, and rule bookkeeping)
// ===========================================================================
...
export {
  ...
  // Namespaces
  RDF_NS, RDFS_NS, OWL_NS, XSD_NS, CRYPTO_NS, MATH_NS, TIME_NS, LIST_NS, LOG_NS, STRING_NS, SKOLEM_NS, RDF_JSON_DT,

  // Option setters
  setEnforceHttpsEnabled, getEnforceHttpsEnabled,
  setProofCommentsEnabled, getProofCommentsEnabled,
  setSuperRestrictedMode, getSuperRestrictedMode,

  // Injection hooks
  installTraceFormatting, setTracePrefixes, installN3Input,

  // Term model
  Term, Iri, Literal, Var, Blank, ListTerm, OpenListTerm, GraphTerm, Triple, Rule, DerivedFact,
  internIri, internLiteral,

  // String + literal helpers
  stripQuotes, decodeN3StringEscapes, literalParts, termToJsString,
  parseNumericLiteralInfo,

  // Rule helpers
  collectBlankLabelsInTriples, liftBlankRuleVars, reorderPremiseForConstraints,

  // Substitution / vars helpers
  applySubstTerm, varsInRule, skolemKeyFromTerm,

  // Predicate helpers (for printing etc.)
  isLogImplies, isLogImpliedBy, isRdfTypePred, isOwlSameAsPred,
