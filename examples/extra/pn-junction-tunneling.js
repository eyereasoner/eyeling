...
function main() {
  ...
  const lines = [];
  lines.push('=== Answer ===');
  lines.push('In this toy PN-junction tunneling model, heavy doping narrows the depletion region enough for a tunneling window that rises to a peak and then falls.');
  lines.push('');
