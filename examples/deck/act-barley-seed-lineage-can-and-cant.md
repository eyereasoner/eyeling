...
> What can a lineage *not* do when digital heredity, repair, protected dormancy, or heritable variation are missing?
...
> given these conditions, X is possible;
> given these missing ingredients, Y is impossible.
...
It says that the laws of nature are not secretly pre-loaded with biological design.
The biological organization must therefore be explainable through the physical possibility of the relevant tasks.
...
Its embryo vehicle supports metabolism, development, copying support, compartment control, and repair.
Its adult vehicle supports metabolism, development, gamete production, and seed construction.
Its seed has a protective seed coat.
Its lineage is marked as having variation present.
...
- no digital hereditary medium
u2192 no accurate genome copying under no-design laws
u2192 no accurate self-reproduction
...
- no protected dormancy
u2192 no lineage closure through the protected seed stage
...
u2192 no adaptive persistence
u2192 no evolvable lineage
...
The first group derives possible tasks and positive lineage properties.
The second group derives blocked tasks and impossible lineage properties.
...
It says accurate self-reproduction is not obtained from copying alone.
It also needs:
...
It marks the lineage as one in which heritable variation is possible.
...
This final positive rule says that evolvability is a composite property.
It is not assumed. It is derived from lower-level task capabilities.
...
This rule is used for `:fragileLine`.
It says that the absence of repair is not a minor defect; it blocks a crucial task.
...
They say that evolvability is fragile in a structured way.
If any of the major task clusters fail, the lineage cannot count as evolvable.
...
It also makes the biological reasoning more informative.
Instead of only learning that the main lineage succeeds, we learn *why the others fail*.
...
> Constructor theory of life is not just about describing successful life-like systems.
> It is also about identifying which life-like tasks become impossible when specific structural ingredients are absent.
...
Each missing ingredient removes a capability.
And those lost capabilities propagate upward into lost lineage-level properties.
