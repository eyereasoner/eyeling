...
- ['examples/act-barley-seed-lineage.n3'](examples/act-barley-seed-lineage.n3) · ['examples/output/act-barley-seed-lineage.txt'](examples/output/act-barley-seed-lineage.txt) — applied constructor-theory ARC case for a salt-tolerant barley lineage covering digital heredity, developmental bottleneck, repair, dormancy, germination, self-reproduction, variation, and selection.
- ['examples/act-barley-seed-lineage-can-and-cant.n3'](examples/act-barley-seed-lineage-can-and-cant.n3) · ['examples/output/act-barley-seed-lineage-can-and-cant.txt'](examples/output/act-barley-seed-lineage-can-and-cant.txt) — applied constructor-theory ARC case showing both possible and impossible lineage tasks under no-design laws, including blocked reproduction, dormancy, and evolvability when key ingredients are missing.
